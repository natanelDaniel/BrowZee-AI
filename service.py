...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # אפשר את כל המקורות
    allow_credentials=True,
    allow_methods=["*"],  # אפשר את כל השיטות, כולל OPTIONS
...
# פונקציה לשליחת הודעות ל-WebSocket
@app.websocket("/ws/status")
...
class Agent(Generic[Context]):
	...
	async def _needs_user_input(self) -> tuple[bool, Optional[str]]:
		...
		prefare to not ask the user. not ask to continue
		Task: "{self.task}
