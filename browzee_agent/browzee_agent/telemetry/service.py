...
from browzee_agent.telemetry.views import BaseTelemetryEvent
from browzee_agent.utils import singleton
...
class ProductTelemetry:
	...
	USER_ID_PATH = str(xdg_cache_home() / '.cache' / 'browzee_agent' / 'telemetry_user_id')
