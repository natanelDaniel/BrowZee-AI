...
from browzee_agent.browser.views import BrowserState, BrowserStateHistory, TabInfo
from browzee_agent.controller.registry.service import Registry
from browzee_agent.controller.views import ClickElementAction, DoneAction, ExtractPageContentAction
from browzee_agent.dom.views import DOMElementNode
...
# run this with:
# pytest browzee_agent/agent/tests.py
