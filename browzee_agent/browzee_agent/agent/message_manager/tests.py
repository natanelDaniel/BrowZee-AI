...
from browzee_agent.agent.views import ActionResult
from browzee_agent.browser.views import BrowserState, TabInfo
from browzee_agent.dom.views import DOMElementNode, DOMTextNode
...
def test_token_overflow_handling_with_real_flow(message_manager: MessageManager, max_tokens):
	...
	for i in range(200):  # Simulate 40 steps of interaction
		...
		from browzee_agent.agent.views import AgentBrain, AgentOutput
...
# pytest -s browzee_agent/agent/message_manager/tests.py
