...
if TYPE_CHECKING:
	from browzee_agent.agent.views import ActionResult, AgentStepInfo
...
class SystemPrompt:
	...
	def _load_prompt_template(self) -> None:
		...
		try:
			...
			with importlib.resources.files('browzee_agent.agent').joinpath('system_prompt.md').open('r') as f:
