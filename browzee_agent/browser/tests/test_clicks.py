...
from browzee_agent.browser.browser import Browser, BrowserConfig
from browzee_agent.dom.views import DOMBaseNode, DOMElementNode, DOMTextNode
...
# run with: pytest browzee_agent/browser/tests/test_clicks.py
@pytest.mark.asyncio
