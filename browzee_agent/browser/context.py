...
class BrowserContext:
	...
	async def _wait_for_page_and_frames_load(self, timeout_overwrite: float | None = None):
		...
		# Wait for page load
		try:
			page = await self._wait_for_stable_network()
	...
	async def take_screenshot(self, page, full_page: bool = False) -> str:
		"""
	...
	async def _get_current_page(self, session: BrowserSession) -> Page:
		...
		non_extension_pages = [
			page for page in pages if not page.url.startswith('chrome-extension://')
		]
